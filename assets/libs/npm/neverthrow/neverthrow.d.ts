...
declare function okAsync<T extends void = void, E = never>(
    value: void
): ResultAsync<void, E>;
declare function errAsync<T = never, E = unknown>(err: E): ResultAsync<T, E>;
declare function errAsync<T = never, E extends void = void>(
    err: void
): ResultAsync<T, void>;
...
declare type CombineResultAsyncs<
    T extends readonly ResultAsync<unknown, unknown>[],
> =
...
declare type InferAsyncOkTypes<R> =
    R extends ResultAsync<infer T, unknown> ? T : never;
declare type InferAsyncErrTypes<R> =
...
declare type MemberListOf<T> = (
    ...
    : [];
declare type EmptyArrayToNever<
    T,
...
declare type CombineResultsWithAllErrorsArray<
    T extends readonly Result<unknown, unknown>[],
> =
    IsLiteralArray<T> extends 1
